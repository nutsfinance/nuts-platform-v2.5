...
module.exports = async function (callback) {
    try {
        ...
        const redemptionTokenName1 = 'Apple ETH Rights Token 3';
        const redemptionTokenSymbol1 = 'APPL ETH 3';
        ...
        const redemptionTokenName2 = 'Apple USDC Rights Token 3';
        const redemptionTokenSymbol2 = 'APPL USDC 3';
        ...
        const redeemAmount = '200000000000000000000';   // 200 rights token
        await instrumentManager.engageIssuance(issuanceId3, web3.eth.abi.encodeParameters(['uint256'], [redeemAmount]), {from: taker});
        ...
        const subscriptionData = {
            ...
            "subscriptionEndTimestamp": now - 15 * day,
            "announceTimestamp": now - 5 * day,
            "redemptionStartTimestamp": now - day,
            "redemptionEndTimestamp": now + 15 * day,
            "fillRatio": 0.64,
            "offers": {
                "ETH": {
