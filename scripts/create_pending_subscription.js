...
module.exports = async function (callback) {
    try {
        ...
        const redemptionTokenName1 = 'Apple ETH Rights Token 2';
        const redemptionTokenSymbol1 = 'APPL ETH 2';
        ...
        const redemptionTokenName2 = 'Apple USDC Rights Token 2';
        const redemptionTokenSymbol2 = 'APPL USDC 2';
        ...
        // Engage subscription issuance
        const engageAmount = '4000000000000000000'; // 4 ETH
        await instrumentEscrow.deposit({from: taker, value: engageAmount});
        await instrumentManager.engageIssuance(issuanceId1, web3.eth.abi.encodeParameters(['uint256'], [engageAmount]), {from: taker});
        ...
        const subscriptionData = {
            ...
            "ticker": "APPL",
            "exchange": "nasdaq",
            "subscriptionStartTimestamp": now - 15 * day,
